...
class PiperGoUtilsTest extends BasePiperTest {
    ...
    void testUnstashPiperBinMaster() {
        ...
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/latest/download/piper_master\'', '200')

        piperGoUtils.unstashPiperBin()
        assertThat(shellCallRule.shell.size(), is(3))
        assertThat(shellCallRule.shell[0].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/latest/download/piper_master\''))
    ...
    void testUnstashPiperBinNonMaster() {
        ...
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/download/testTag/piper\'', '200')

        piperGoUtils.unstashPiperBin()
        assertThat(shellCallRule.shell.size(), is(3))
        assertThat(shellCallRule.shell[0].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/download/testTag/piper\''))
        assertThat(shellCallRule.shell[1].toString(), is('chmod +x piper'))
        assertThat(shellCallRule.shell[2].toString(), is('./piper version'))
    }
    ...
    void testUnstashPiperBinFallback() {
        ...
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/download/notAvailable/piper\'', '404')
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/latest/download/piper_master\'', '200')
        ...
        assertThat(shellCallRule.shell[0].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/download/notAvailable/piper\''))
        assertThat(shellCallRule.shell[1].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/latest/download/piper_master\''))
    ...
    void testDownloadFailedWithErrorCode() {
        ...
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/download/notAvailable/piper\'', '404')
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/HoffmannThomas/jenkins-library/releases/latest/download/piper_master\'', '500')
