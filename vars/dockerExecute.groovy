...
@Field Set STEP_CONFIG_KEYS = GENERAL_CONFIG_KEYS.plus([
     ...
     * Omit to use the default image (cf. [default_pipeline_environment.yml](https://github.com/HoffmannThomas/jenkins-library/blob/master/resources/default_pipeline_environment.yml))
